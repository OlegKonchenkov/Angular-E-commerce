...
@Component({
  selector: 'app-interesting-for-you',
  templateUrl: './interesting-for-you.component.html',
  styleUrls: ['./interesting-for-you.component.scss']
})
export class InterestingForYouComponent implements OnInit {
  ...
  ngOnInit(): void {
    this._http.InterestProducts().subscribe((response) => {
      ...
      this.interestProducts = response["body"]["products"];
