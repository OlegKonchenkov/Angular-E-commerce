...
@Component({
  selector: 'app-offers-of-the-moment',
  templateUrl: './offers-of-the-moment.component.html',
  styleUrls: ['./offers-of-the-moment.component.scss']
})
export class OffersOfTheMomentComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this._http.SalesProducts().subscribe((response) => {
      ...
      this.salesProducts = response["body"]["products"];
